...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # self.setGeometry(100, 60, 1214, 665)
        ...
        lblVersion = QLabel('Version : 12.20')
        ...
        db.setDatabaseName('data/VideoLearnerX12.db')
        # if db.open():
        ...
        menuItemAbout = QAction(QIcon(None), 'About VideoFinder', self)
        ...
        menuItemPreferences = QAction(QIcon(None), 'Préférences', self)
        ...
        menuAddVideo = QAction(QIcon(None), 'Add video', self)
        ...
        menuRankedVideo = QAction(QIcon(None), 'Ranked video', self)
        ...
        menuStoreVideo = QAction(QIcon(None), 'Store video', self)
...
class FormEditionVideo(MainWindowCustom):
    ...
    def populateTableMatiere(self):
        ...
        while query.next():
            ...
            lbl.setStyleSheet('background: #222222')  # ; border-top: 5px solid #333333; border-bottom: 5px solid #333333
            font2 = QFont()
            font2.setFamily('Arial')
            font2.setPointSize(10)
            font2.setBold(False)
        ...
        for ligne in range(0, self.nbLigne):
            for colonne in range(0, 4):
                ...
                if index < lenLstVideo:
                    ...
                    lblTitre.setStyleSheet("QToolTip { color: #ffffff; background-color: #333333; border: 1px solid #555555; }")
                    # ****************************************************************
...
class GridWindow(QWidget):
    ...
    def initUI1(self):
        ...
        lblLogo.setStyleSheet('color: #ef5a24; background-color: #171717')
        ...
        self.grpLeftTop.setFixedWidth(275)
        ...
        # f = open('styles/StyleComboBox.txt', 'r')
        f = open('styles/QComboBox.txt', 'r')
        style = f.read()
        styleQComboBox = style
        self.listSelectItem.setStyleSheet(styleQComboBox)
        self.listSelectItem.setFixedWidth(247)
        ...
        #  Bouton down arrow
        btnDownArrow = QPushButton(self.grpLeftTop)
        btnDownArrow.setFixedSize(28, 26)
        btnDownArrow.setStyleSheet('QPushButton {background-color: #444444;} '
                                   'QPushButton::hover {background-color: #666666}')
        btnDownArrow.setIcon(QIcon('ressources/FlecheComBox.png'))
        btnDownArrow.move(243, 0)
        btnDownArrow.clicked.connect(self.listSelectItem.showPopup)
        # #  populate
